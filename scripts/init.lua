...
Tracker:AddItems("items/ap_settings/enabled_bonuses.json")
Tracker:AddItems("items/ap_settings/enabled_chapters.json")
Tracker:AddItems("items/ap_settings/enabled_episodes.json")
Tracker:AddItems("items/ap_settings/enabled_locations.json")
Tracker:AddItems("items/ap_settings/goals.json")
Tracker:AddItems("items/ap_settings/logic_settings.json")
Tracker:AddItems("items/ap_settings/chapter_requirement_excluded_characters.json")
